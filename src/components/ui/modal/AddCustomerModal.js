...
const AddCustomerModal = ({ isOpen, onClose, onSave }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // toast.success(t("CREATED_SUCCESS")); // Already handled in view by toast.promise
            onClose();
            setFormData({
                name: "",
                email: "",
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 text-left align-middle shadow-xl transition-all flex flex-col max-h-[90vh]">
                                ...
                                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t("DATE_OF_BIRTH")}</label>
                                            <input
                                                type="date"
                                                name="dob"
                                                value={formData.dob}
                                    ...
                                    <div className="px-0 py-4 border-t border-gray-100 dark:border-gray-700 flex items-center justify-end gap-3 mt-auto">
                                        ...
                                        >
                                            {loading ? t("CREATING") : t("ADD_CUSTOMER")}
                                        </button>
                                    </div>
                                </form>
                            </Dialog.Panel>
