...
export default function UserAddressCard() {
  ...
  const getAddressTypeLabel = (type) => {
    switch (parseInt(type)) {
      case 0: return t("HOME");
      case 1: return t("OFFICE");
      case 2: return t("OTHER");
  ...
  return <>
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={openModal} className="flex items-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
